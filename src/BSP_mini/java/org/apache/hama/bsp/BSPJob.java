...
public void setBspClass(Class<? extends BSP> cls)
  ...
  public void setNumOfCenters(int k) {
	  conf.setInt("kmeans.center.number", k);
  }
  
  public int getNumOfCenters() {
	  return conf.getInt("kmeans.center.number", 2);
  }
  
  public void setNumOfDimensions(int dim) {
	  conf.setInt("kmeans.dimension.number", dim);
  }
  
  public int getNumOfDimensions() {
	  return conf.getInt("kmeans.dimension.number", -1);
  }
  ...
  public void setSyncModel(int model) {
	  conf.setInt("kmeans.sync.model", model);
  }
  ...
  public int getSyncModel() {
	  return conf.getInt("kmeans.sync.model", Constants.SyncModel.Concurrent);
  }
  ...
  public void setBlockSize(int size) {
	  conf.setInt("kmeans.block.size", size);
  }
  ...
  public int getBlockSize() {
	  return conf.getInt("kmeans.block.size", 1000);
  }
  
  /**
   * Set the barrier interval (millisecond).
   * @param num
   */
  public void setBarrierInterval(int interval) {
	  conf.setInt("kmeans.barrier.interval", interval);
  }
  
  /**
   * Get the barrier interval, return 500 millisecond as default.
   * @return
   */
  public int getBarrierInterval() {
	  return conf.getInt("kmeans.barrier.interval", 500);
  }
  ...
  public void setIdleTime(int idle) {
	  conf.setInt("kmeans.idle.time", idle);
  }
  ...
  public int getIdleTime() {
	  return conf.getInt("kmeans.idle.time", -1);
  }
  ...
  public void setFuzzy(float fuzzy) {
	  conf.setFloat("fcm.fuzzy", fuzzy);
  }
  
  public float getFuzzy() {
	  return conf.getFloat("fcm.fuzzy", 1.1f);
  }
