...
public class GMMDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length != 13) {
			StringBuffer sb = 
				new StringBuffer("the GMM job must be given arguments(13):"); 
			...
			sb.append("\n  [12] converge_threshold (double)");
			sb.append("\n  [13] data load skew (double, 0.0<=skew<1.0)");
		...
		bsp.setGMM();
		bsp.setConvergeValue(args[11]);
		bsp.setDataLoadSkew(args[12]);
