...
public class FormatAddId {
	...
	public static void main(String[] args) throws Exception {
		...
		while((context=br.readLine()) != null) {
			...
			dimNum = dims.length - 2;
			sb.append(Double.toString(Double.parseDouble(dims[1])));
			for (int i = 2; i < (dims.length); i++) {
				sb.append(",");
				sb.append(Double.toString(Double.parseDouble(dims[i])));
			}
		...
		System.out.println("#dims=" + dimNum);
