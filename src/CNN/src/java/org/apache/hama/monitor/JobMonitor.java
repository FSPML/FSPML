...
public class JobMonitor {
	...
	public synchronized void updateMonitor(int curIteNum, int taskId, 
		...
		LOG.info("curIteNum : " + curIteNum +" taskId : " + taskId+ " deltaAgg : " + aggTask);
	}
	...
	public void computeAgg(int curIteNum) {
		...
		if (curIteNum > 1) {
			...
			LOG.info("curIteNum : " + curIteNum + " deltaAggSum : " + this.agg_list.get(idx));
		}else {
			LOG.info("curIteNum : " + curIteNum + " deltaAggSum : " + this.agg_list.get(0));
		}
	}
