...
public class FCMDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length != 15) {
			StringBuffer sb = 
				new StringBuffer("the Fuzzy C-Means job must be given arguments(15):"); 
			...
			sb.append("\n  [11] #idle_time per 1000 points (int, milliseconds, -1=>disabled, -2=>Multithreading simulation)");
			sb.append("\n  [12] #idle_task (int, 0=>disabled)");
			sb.append("\n  [13] converge_threshold (double)");
			sb.append("\n  [14] data load skew (double, 0.0<=skew<1.0)");
			sb.append("\n  [15] load migration ? (int, 1 => yes ,-1 => no, 2=>block)");
		...
		bsp.setIsMigration(Integer.parseInt(args[14]));
