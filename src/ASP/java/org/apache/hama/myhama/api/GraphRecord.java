...
public class GraphRecord<V, W, M, I> implements Writable {
	...
	protected V baseVerValue; //used to save first ite verValue;
	private boolean isSend = false;//Used to determine whether the point is sent out
	private boolean isFirstCompute = true; //used to determine whether the point is first compute
	...
	public boolean isFirstCompute() {
		return isFirstCompute;
	}

	public void setFirstCompute(boolean isFirstCompute) {
		this.isFirstCompute = isFirstCompute;
	}
	
	public V getBaseVerValue() {
		return baseVerValue;
	}

	public void setBaseVerValue(V baseVerValue) {
		this.baseVerValue = baseVerValue;
	}
	...
	public void write(DataOutput out) throws IOException {
    	...
    	out.writeBoolean(isFirstCompute);
    }
	...
	public void readFields(DataInput in) throws IOException {
    	...
    	this.isFirstCompute = in.readBoolean(); 	
    }
