...
import hybridgraph.examples.nmf.distributed.NMFDriver;
import hybridgraph.examples.sgd.data.FormatData;
...
public class ExampleDriver {
	...
	public static void main(String argv[]){
	    ...
	    try {
	    	...
	    	/** distributed SGD */
	    	pgd.addClass("sgd.format.data", FormatData.class, 
    			"\tdistributed logr impl. under CONCURRENT or SemiAsyn model (05/07/2021)");
	    	
	    	pgd.addClass("nmf.semiasyn", NMFDriver.class, 
	    			"\tdistributed nmf impl. under CONCURRENT or SemiAsyn model (10/28/2021)");
