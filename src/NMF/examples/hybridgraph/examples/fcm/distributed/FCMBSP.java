...
public class FCMBSP extends BSP<FCMValue, Integer, Integer, Integer> {
	...
	@Override
	public void getLocalData(GraphRecord<FCMValue, Integer, Integer, Integer>[][] localPoints) {
		// do nothing
	}

	@Override
	public void taskSetup(Context<FCMValue, Integer, Integer, Integer> context) {
		this.numOfCentroids = context.getBSPJobInfo().getNumOfCenters();
		this.numOfDimensions = context.getBSPJobInfo().getNumOfDimensions();
	}
	
	@Override
	public void superstepSetup(Context<FCMValue, Integer, Integer, Integer> context) {
	...
	@Override
	public void updateOnGpu(Context<FCMValue, Integer, Integer, Integer> context) throws Exception {
