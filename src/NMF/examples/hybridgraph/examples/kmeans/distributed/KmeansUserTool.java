 ...
 */
public class KmeansUserTool extends UserTool<KmeansValue, Integer, Integer, Integer> {
	private static EdgeParser edgeParser = new EdgeParser();
	
	public static class KmeansRecord extends GraphRecord<KmeansValue, Integer, Integer, Integer> {
