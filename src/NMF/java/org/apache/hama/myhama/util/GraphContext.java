...
public class GraphContext<V, W, M, I> extends Context<V, W, M, I> {
	 ...
	 * @param _iteNum
	 */
	public GraphContext(int taskId, BSPJob job, int iteNum, MatrixOfNMF matSet, double[][] matrixH, int line) {
		super(taskId, job, iteNum);
		this.matSet = matSet;
...
//		this.matrixV = matrixV;
	 ...
	 * @param _actFlag
	 */
	public void initialize(GraphRecord<V, W, M, I> graph, double jobAgg) {
		this.graph = graph;
		this.jobAgg = jobAgg;
	}
